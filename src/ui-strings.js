(function exposeUIStrings(global) {
  ...
  const STRINGS = Object.freeze({
    latin: Object.freeze({
      ...
      siteRemembered: "Zapamćeno za {site}. Pristup važi samo za odobrene adrese tog sajta.",
    ...
    cyrillic: Object.freeze({
      ...
      siteRemembered: "Запамћено за {site}. Приступ важи само за одобрене адресе тог сајта.",
